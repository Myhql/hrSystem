      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0" class="CContent">
        <tr>
          ...
          <table width="95%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
            <tr class="CTitle" >
            <td height="22" colspan="11" align="center" style="font-size:16px"><h3>添加失敗,该岗位已经存在！！！</h3></td>
			</tr>
			<tr>
			<td align="center">   
				<input type="button" name="cancel" onclick="javascript:history.back(-1);" value="请重新添加"  />
			</td>
			</tr>
			</table></td>
      	</tr>
