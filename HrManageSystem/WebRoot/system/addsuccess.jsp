      ...
      <table width="97%" border="0" cellpadding="0" cellspacing="0" class="CContent">
        <tr>
          ...
          <table width="95%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
            <tr class="CTitle" >
            <td height="22" colspan="11" align="center" style="font-size:16px"><p>恭喜，添加成功！！！</p></td>
			</tr>
			<tr>
			<td align="center">
			  <input type="submit" name="save" value="GO登录" />
	       		&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     
				<input type="button" name="cancel" onclick="javascript:history.back(-1);" value="返回上一页"  />
			</td>
			</tr>
			</table></td>
      	</tr>
