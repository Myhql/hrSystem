...
document.write("<script src='${pageContext.request.contextPath}/js/nav.jsp' charset='utf-8'></" + "script>");
</script>
</head>
<body onload="initinav('组织管理')">
<div id="left_content">
  <div id="user_info">欢迎您，<strong>${sessionScope.username }</strong><br />  
       <span class="STYLE2">
       <!-- #BeginDate format:fcCh2m -->
