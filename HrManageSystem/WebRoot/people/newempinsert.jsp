...
<div id="man_zone">
  <form action="${pageContext.request.contextPath}/emp/queryByIdCard" onsubmit="return link();" method="post" enctype="multipart/form-data" name="fom" id="fom" target="manFrame" >
    <div class="MainDiv">
